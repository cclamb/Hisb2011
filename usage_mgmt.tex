...
Whereas this is an overly simplified example of usage rules, existing languages on usage control~\cite{PaSa:04,JaHeLa:10} may be used for specifying complex usage policies for controlling the manner in which medical records may be used within the system. 
